        ...
        <div class="relative h-full flex-1 overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700">
            <div class="relative">
                ...
                <div class="absolute text-center w-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 px-6 sm:px-10 flex flex-col gap-6 sm:gap-10">
                    ...
                    <p>
                        <flux:button variant="primary" color="amber" icon="user-group" :href="route('engineers')" wire:navigate>Mérnökeink</flux:button>
                        <flux:button variant="primary" color="zinc" icon="chat-bubble-bottom-center-text" :href="route('messages.create')" wire:navigate>Kapcsolat</flux:button>
                    </p>
                </div>
            </div>
        </div>
